...
public enum JoinTypeEnum {
    ...
    public static JoinTypeEnum getEnum(String code) {
        return Arrays.stream(JoinTypeEnum.values()).filter(node -> StrUtil.equals(node.getCode(), code)).findAny().orElse(EMPTY);
    }
